...
const forecast = (latitude, longitude, callback) => {
    ...
    request({ url , json: true}, (error,{body}) => {
       ...
       if(error){
          ...
          callback(undefined, body.current.weather_descriptions[0] + '.It is Currently a ' + body.current.temperature + ' '  + 'out there. There is no' + ' ' + body.current.feelslike + ' ' + '% chance of rain.')
        }
